...
function VisualizarAdmin(props) {
          ...
          <Modal.Header closeButton>
            ...
            <Modal.Body>
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                ...
                <h3>{props.view.numCollection}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Nome:</h3>
              ...
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Imagem:</h3>
                <h3>{props.view.image}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Coleção:</h3>
                <h3>{props.view.collec}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Categoria:</h3>
                <h3>{props.view.category}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Descrição:</h3>
                <h3>{props.view.description}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Origem:</h3>
                <h3>{props.view.origin}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Cenpaleo:</h3>
                <h3>{props.view.cenpaleo}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Localização no Cenpaleo:</h3>
                <h3>{props.view.location_in_cenpaleo}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Coletor:</h3>
                <h3>{props.view.collector}</h3>
              </div> 
              <div className="p-2 mb-2 rounded text-white bg-dark d-flex justify-content-between">
                <h3>Data da Coleta:</h3>
                <h3>{props.view.collectionDate}</h3>
              </div> 
            </Modal.Body>
            <Modal.Footer>
...
export default VisualizarAdmin;